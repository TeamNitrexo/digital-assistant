...
class Lessons(EmbeddedDocument):
    lesson_title = StringField(
        max_length = 200,
        required = True
    )

    lesson_number = StringField(
        max_length = 200,
        required = True
    )
...
class Chapters(EmbeddedDocument):
    ...
    lessons = ListField(EmbeddedDocumentField(Lessons))


class Tutorials(Document):
    name = StringField(
        max_length = 200,
        required = True
    )
...
class Videos(Document):
    tutorial_id_reference = StringField(max_length = 500)
    ...
    video_name = StringField(max_length = 200)
